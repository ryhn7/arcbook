      ...
      child: Center(
        child: SizedBox(
          height: MediaQuery.of(context).size.height *
              0.3, // Dynamically scale based on screen height
          width: 172,
          child: ClipRRect(
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildInfoItem(
                    Icons.book, widget.bookModel.bookPages.toString(), 'Pages',
                    iconColor: onyx),
                const SizedBox(
                  height: 56,
                  child: VerticalDivider(
            ...
            children: [
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isBookmarked ? const Color(0xFFFFE6E9) : cultured,
                    borderRadius: BorderRadius.circular(8),
                  ),
                  child: Image.asset(
                    isBookmarked
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  child: Text(
                    'Start Reading',
                    style: getPoppinsSemiBoldStyle16(color: Colors.white),
                  ),
                ),
              ),
            ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        // Wrap in SingleChildScrollView for vertical scrolling
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            bookCoverSection(),
